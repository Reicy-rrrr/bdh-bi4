...
public class BiUiAnalyseCategoryController {
    ...
    public RetResult<List<AnalyseCategoryTree>> getCategoryTree(@RequestBody @Validated RetRequest<GetCategoryDto> request) {
    ...
    public RetResult<List<AnalyseCategoryTree>> getDefaultCategoryTree(@RequestBody @Validated RetRequest<GetCategoryDto> request) {
    ...
    public RetResult<List<AnalyseCategoryTree>> getCustomerCategoryTree(@RequestBody @Validated RetRequest<GetCategoryDto> request) {
    ...
    public RetResult<PageResult<List<BiUiAnalyseCategory>>> getAnalyseCategoryList(@RequestBody @Validated PageRequest<GetCategoryDto> request) {
    ...
    public RetResult<BiUiAnalyseCategory> createAnalyseCategory(@RequestBody @Validated RetRequest<CreateAnalyseCategoryDto> request) {
        return RetResponse.makeOKRsp(biUiAnalyseCategoryService.createAnalyseCategory(request));
    }
    ...
    public RetResult<Void> batchDelAnalyseCategories(@RequestBody @Validated RetRequest<BatchDeleteCategoryDto> request) {
        biUiAnalyseCategoryService.batchDelAnalyseCategories(request);
        return RetResponse.makeOKRsp();
    }
    ...
    public RetResult<BiUiAnalyseCategory> updateAnalyseCategory(@RequestBody @Validated RetRequest<UpdateCategoryDto> request) {
        return RetResponse.makeOKRsp(biUiAnalyseCategoryService.updateAnalyseCategory(request));
    }
    ...
    public RetResult<Void> initTenantAnalyse(@RequestBody @Validated RetRequest<Void> request) {
        biUiAnalyseCategoryService.initTenantAnalyse(request);
        return RetResponse.makeOKRsp();
    }
    ...
    public RetResult<List<BiUiAnalysePage>> getChildAnalysePageList(@RequestBody @Validated RetRequest<GetAnalysePageDto> request) throws Exception {
        return RetResponse.makeOKRsp(biUiAnalyseCategoryService.getChildAnalysePageReq(request));
    }
}
