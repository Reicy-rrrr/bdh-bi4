    ...
    public void setCategoryPermission(List<AnalyseCategoryDto> categoryList) {
        ...
        if (CollectionUtils.isNotEmpty(categoryResources)) {
            ...
            for (AnalyseCategoryDto dto : categoryList) {
                ...
                if (resource != null) {
                    if (StringUtils.containsOnly(PermittedActionEnum.VIEW.getCode(), resource.getPermittedAction())) {
                        dto.setPermittedAction(PermittedActionEnum.VIEW.getCode());
                    } else {
                        dto.setPermittedAction(StringUtils.join(PermittedActionEnum.VIEW.getCode(), PermittedActionEnum.EDIT.getCode()));
                    }
                } else {
                    dto.setPermittedAction(StringUtils.join(PermittedActionEnum.VIEW.getCode(), PermittedActionEnum.EDIT.getCode()));
                }
