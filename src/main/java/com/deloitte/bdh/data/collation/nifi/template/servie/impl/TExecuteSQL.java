...
@Service("tExecuteSQL")
public class TExecuteSQL implements TProcessor {
    @Resource
    ...
    public boolean update(String processorId, Map<String, Object> var) throws Exception {
        ...
        properties.put(BiParamsEnum.DCPS.getKey(), "a5b9fc8e-0174-1000-0000-000039bf90cc");
        properties.put(BiParamsEnum.SQLselectquery.getKey(),  MapUtils.getString(var, BiParamsEnum.SQLselectquery.getKey()));
