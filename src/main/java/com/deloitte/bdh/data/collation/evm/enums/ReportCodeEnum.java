...
public enum ReportCodeEnum {
    ...
    ZJB("ZJB", "资金表") {
        ...
        public ImmutablePair<List<String>, List<Rule>> relySheets() {
            ...
            List<Rule> collusion = Lists.newArrayList(
                    new Rule("EVM0001", "资金总额", "{N#zcfzb.EVMB003}+{N#zcfzb.EVMB004}", "资金")
                    , new Rule("EVM0002", "资金占总资产比率", "({N#zcfzb.EVMB003}+{N#zcfzb.EVMB004})/{N#zcfzb.EVMB039}", "资金")
                    , new Rule("EVM0003", "资金周转率", "{N#kmyeb.M132}/({N#zcfzb.EVMB003_AVG}+{N#zcfzb.EVMB004_AVG})", "资金")
...
//                    , new Rule("EVM0006", "存货周转天数", "360/({N#lrb.EVMP002}/{N#zcfzb.EVMB012_AVG})")
                    , new Rule("EVM0007", "现金周转天数", "(360/({N#lrb.EVMP001}/{N#zcfzb.EVMB008_AVG}))-(360/({N#lrb.EVMP001}/{N#zcfzb.EVMB046_AVG}))+(360/({N#lrb.EVMP002}/{N#zcfzb.EVMB012_AVG}))", "资金")
                    , new Rule("EVM0008", "期末资金集中度", "1+1", "资金规划")
                    , new Rule("EVM0009", "资金计划报送及时率", "1+1", "资金规划")
                    , new Rule("EVM0010", "资金计划执行准确率", "1+1", "资金规划")
                    , new Rule("EVM0011", "经营活动现金流入", "{N#xjllb.EVMC005}", "经营活动现金流量")
                    , new Rule("EVM0012", "经营活动现金流出", "{N#xjllb.EVMC010}", "经营活动现金流量")
                    , new Rule("EVM0013", "经营活动产生的现金流量", "{N#xjllb.EVMC011}", "经营活动现金流量")
                    , new Rule("EVM0014", "投资活动现金流入", "{N#xjllb.EVMC018}", "经营活动现金流量")
                    , new Rule("EVM0015", "投资活动现金流出", "{N#xjllb.EVMC023}", "经营活动现金流量")
                    , new Rule("EVM0016", "投资活动所用的现金流量净额", "{N#xjllb.EVMC024}", "经营活动现金流量")
                    , new Rule("EVM0017", "融资活动现金流入", "{N#xjllb.EVMC029}", "经营活动现金流量")
                    , new Rule("EVM0018", "融资活动现金流出", "{N#xjllb.EVMC033}", "经营活动现金流量")
                    , new Rule("EVM0019", "融资活动所产生(使用)的现金流量净额", "{N#xjllb.EVMC034}", "经营活动现金流量")
                    , new Rule("EVM0020", "短期借款", "{N#zcfzb.EVMB042}", "债务结构")
                    , new Rule("EVM0021", "应付票据", "{N#zcfzb.EVMB045}", "债务结构")
                    , new Rule("EVM0022", "应付账款", "{N#zcfzb.EVMB046}", "债务结构")
                    , new Rule("EVM0023", "预收账款", "{N#zcfzb.EVMB047}", "债务结构")
                    , new Rule("EVM0024", "流动负债", "{N#zcfzb.EVMB042}+{N#zcfzb.EVMB045}+{N#zcfzb.EVMB046}+{N#zcfzb.EVMB047}", "债务结构")
                    , new Rule("EVM0025", "长期借款", "{N#zcfzb.EVMB057}", "债务结构")
                    , new Rule("EVM0026", "应付债券", "{N#zcfzb.EVMB058}", "债务结构")
                    ...
                    , new Rule("EVM0034", "产权比率", "{N#zcfzb.EVMB068}/{N#zcfzb.EVMB080}", "长期偿债能力")
                    , new Rule("EVM0035", "有形资产债务率", "{N#zcfzb.EVMB068}/({N#zcfzb.EVMB080}-{N#zcfzb.EVMB032})", "长期偿债能力")
                    , new Rule("EVM0036", "资产总额", "{N#zcfzb.EVMB039}", "长期偿债能力")
                    , new Rule("EVM0037", "负债总额", "{N#zcfzb.EVMB068}", "长期偿债能力")
                    , new Rule("EVM0038", "利息偿付倍数", "({N#lrb.EVMP022}-{N#lrb.EVMP008})/{N#lrb.EVMP008}", "长期偿债能力")
                    , new Rule("EVM0039", "经营活动现金流量", "{N#xjllb.EVMC011}", "资金")
                    , new Rule("EVM0040", "运营资金周转率", "{N#xjllb.EVMC011}/({N#zcfzb.EVMB017_AVG}-{N#zcfzb.EVMB055_AVG})", "资金")
                    , new Rule("EVM0041", "应收账款余额", "{N#zcfzb.EVMB008}", "应收")
                    , new Rule("EVM0042", "坏账准备", "{N#kmyeb.M020}", "应收")
                    , new Rule("EVM0043", "应收账款周转率", "{N#lrb.EVMP001}/{N#zcfzb.EVMB008_AVG}", "应收")
                    , new Rule("EVM0044", "应收账款周转天数", "360/({N#lrb.EVMP001}/{N#zcfzb.EVMB008_AVG})", "应收")
                    , new Rule("EVM0045", "营业收入", "{N#lrb.EVMP001}", "应收")
                    , new Rule("EVM0046", "应收占比", "{N#zcfzb.EVMB008}/{N#lrb.EVMP001}", "应收")
                    , new Rule("EVM0047", "应收账款净额", "{N#zcfzb.EVMB008}-{N#kmyeb.M020}", "应收")
                    , new Rule("EVM0048", "应收账款净额", "{N#zcfzb.EVMB008}-{N#kmyeb.M020}", "应收")
                    , new Rule("EVM0049", "逾期应收账款余额", "{N#yszkb.YS_TOTAL}", "应收")
                    , new Rule("EVM0050", "逾期应收款占比", "{N#yszkb.YS_TOTAL}/{N#zcfzb.EVMB008}", "应收")
                    , new Rule("EVM0051", "应付账款余额", "{N#zcfzb.EVMB046}", "应付")
                    , new Rule("EVM0052", "应付账款周转率", "{N#lrb.EVMP001}/{N#zcfzb.EVMB046_AVG}", "应付")
                    , new Rule("EVM0053", "应付账款周转天数", "360/({N#lrb.EVMP001}/{N#zcfzb.EVMB046_AVG})", "应付")
