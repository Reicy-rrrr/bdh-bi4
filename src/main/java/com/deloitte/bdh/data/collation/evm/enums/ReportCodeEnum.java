...
public enum ReportCodeEnum {
    ...
    ZCXLZTSPB("ZCXLZTSPB", "资产效率整体水平表") {
        ...
        public ImmutablePair<List<String>, List<Rule>> relySheets() {
            List<String> relySheets = Lists.newArrayList("zcfz");
            ...
            Rule rule4 = new Rule(5, "EVM0005", "存货周转率", "{N#zcfz.EVMB012_AVG}");
            Rule rule5 = new Rule(6, "EVM0006", "存货周转天数", "360/{N#zcfz.EVMB012_AVG}");
            Rule rule6 = new Rule(7, "EVM0007", "净资产", "{N#zcfz.EVMB080}");
            Rule rule7 = new Rule(8, "EVM0008", "净资产收益率", "{N#zcfz.EVMB080_AVG}");
            Rule rule8 = new Rule(9, "EVM0009", "应收账款", "{N#zcfz.EVMB080}");
//            Rule rule9 = new Rule(10, "EVM0010", "逾期应收账款", "{N#zcfz.EVMB080}");
//            Rule rule10 = new Rule(11, "EVM0011", "应收账款周转率", "{N#zcfz.EVMB037}");
            Rule rule11 = new Rule(12, "EVM0012", "总资产周转率 （次数）", "{N#zcfz.EVMB039_AVG}");
            Rule rule12 = new Rule(13, "EVM0013", "总资产周转天数", "360/{N#zcfz.EVMB039_AVG}");
            ...
            Rule rule16 = new Rule(17, "EVM0017", "固定资产周转率", "{N#zcfz.EVMB037_AVG}");
            Rule rule17 = new Rule(18, "EVM0018", "固定资产周转天数", "360/{N#zcfz.EVMB037_AVG}");
            collusion.add(rule0);
            collusion.add(rule1);
            collusion.add(rule2);
            collusion.add(rule3);
