 ...
 */
@Service("GetMongo")
public class GetMongo extends AbstractProcessor {

    private static final String MONGO_URI_TEMPLATE = "mongodb://{0}:{1}";
    ...
    public Map<String, Object> save(ProcessorContext context) throws Exception {
        BiEtlDatabaseInf database = context.getBiEtlDatabaseInf();
        // 配置数据源的
        Map<String, Object> properties = Maps.newHashMap();
        // properties.put("mongo-client-service", "");
        properties.put("Mongo URI", MessageFormat.format(MONGO_URI_TEMPLATE, mongoHost, String.valueOf(mongoPort)));
        properties.put("Mongo Database Name", mongoDB);
        properties.put("Mongo Collection Name", database.getDbName());
    ...
    protected ProcessorTypeEnum processorType() {
        return ProcessorTypeEnum.GetMongo;
    }
}
