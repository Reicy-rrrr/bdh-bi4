 ...
 * @date 04/08/2020
 */
public class CodeGenerator_Platform {

	private static final String APPLICATION_MODULE = "data";
	private static final String DAO_MODULE = "platform";
	private static final String DSConstantName = "PLATFORM_DB";
	private static final boolean fileOverrideFlag = true;
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:oracle:thin:@10.81.128.246:1521/PORTALDB");
		...
		// 公共父类
		// 写于父类中的公共字段
		strategy.setInclude("FND_PORTAL_USER");
