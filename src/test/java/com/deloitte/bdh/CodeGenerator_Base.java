 ...
 * @date 04/08/2020
 */
public class CodeGenerator_Base {

	private static final String APPLICATION_MODULE = "data";
	private static final String DAO_MODULE = "base";
	private static final String DSConstantName = "BASE_DB";
	...
	public static void main(String[] args) {
		...
		// 公共父类
		// 写于父类中的公共字段
		strategy.setInclude("BASE_ENUM_VALUE");
