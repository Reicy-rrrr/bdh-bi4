 ...
 * @date 04/08/2020
 */
public class CodeGenerator_Expense {

	private static final String APPLICATION_MODULE = "data";
	private static final String DAO_MODULE = "expense";
	private static final String DSConstantName = "EXPENSE_DB";
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:oracle:thin:@10.81.128.246:1521/ECSDB");
		// dsc.setSchemaName("public");
		dsc.setDriverName("oracle.jdbc.OracleDriver");
		dsc.setUsername("ecsapps");
